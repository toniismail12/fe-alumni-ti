                ...
                <div className="flex h-screen">
                    ...
                    <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
                        <div className="max-w-md w-full p-6">
                            ...
                            <h1 className="text-sm font-semibold mb-1 text-gray-500 text-center">
                                Alumni Teknologi Informasi
                            </h1>
                           
                            <div className="mb-3 text-sm text-gray-600 text-center">
                                <p>Fakultas Teknik </p>
                                <p>Universitas Muhammadiyah Palembang</p>
                            </div>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300 mt-3"
                                    >
                                        Login
                                    </button>
                                </div>
